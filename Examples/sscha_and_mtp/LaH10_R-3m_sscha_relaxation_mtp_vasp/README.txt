Relaxation of LaH10 (R-3m) structure at 160 GPa and 300 K within stochastic self-constistent harmonic approxiamtion (SSCHA) using moment tensor potentials (MTP) actively learned on energies, forces, and stresses calculated with Vienna Ab initio Simulation Package (VASP). The relaxed structure should have Fm-3m spacegroup.
...
The directory with VASP pseudopotentials should be explicitly pointed in the input_sscha.py file. 