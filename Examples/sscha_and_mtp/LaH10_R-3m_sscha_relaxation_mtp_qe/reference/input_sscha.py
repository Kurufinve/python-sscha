...
# MLIP parameters
path_to_mlip = '/cephfs/home/dpoletaev/soft/mlip-3/bin/mlp'
...
calculator_run_command = f'/cephfs/home/dpoletaev/soft/interface-lammps-mlip-3/lmp_mpi'
...
ab_initio_parameters = {
                        ...
                        "control":{
                            "pseudo_dir" : "/cephfs/home/dpoletaev/Potentials/QE", # The directory of the pseudo potentials
...
### Cluster parameters (NOT working with VASP!!!)

# hpc_terminal         = "#!/bin/bash"
# hpc_hostname         = "zhores-new" # here we specify the cluster ip address or name (if it is stated in .ssh/config file)
# hpc_workdir          = "/beegfs/home/d.poletaev/uspex/sscha/LaH10/remote_folder"
# hpc_partition_name   = "gpu"
# hpc_use_account      = False 
# # hpc_label            = "EFS4MTP_"
# hpc_add_set_minus_x  = False
# hpc_binary           = "pw.x -npool NPOOL -in  PREFIX.pwi > PREFIX.pwo"
# hpc_load_modules     = """
# #SBATCH --mem-per-cpu=40G
# #SBATCH --gpus=1   # make GPUs visible
# module load nvhpc/21.7
# module load intel/mkl/2020
# export PATH=/beegfs/home/d.poletaev/soft/qe-7.1-epw-gpu-build/bin:$PATH
# export USEGPU=yes
# """
# hpc_n_cpu            = 1
# hpc_n_nodes          = 1
# hpc_n_pool           = 1
# hpc_mpi_cmd          = "mpirun -np NPROC "
# hpc_use_partition    = True
# hpc_use_qos          = False
# hpc_batch_size       = 1
# hpc_job_number       = 1
# hpc_time             = "10:00:00"
